...
final class ImageProcessorTests: XCTestCase {
    ...
    func testProcessImageForUpload_Success() throws {
        ...
        XCTAssertEqual(result.originalSize, CGSize(width: 1600, height: 1200))
        XCTAssertTrue(result.processedSize.width <= targetSize.width)
        XCTAssertTrue(result.processedSize.height <= targetSize.height)
